    ...
    <section className="section bg-secondary-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 md:mb-12">
          ...
          <p className="mt-3 md:mt-4 text-base md:text-lg text-gray-400">Simple steps to start sharing or finding skills</p>
        </div>
        
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3 md:gap-8">
          <div className="bg-secondary-900/50 rounded-xl p-4 md:p-6 border border-secondary-800 hover:border-primary-500/50 transition-all duration-300">
            <div className="flex items-center mb-4 md:mb-6">
              <div className="flex-shrink-0">
                <div className="flex items-center justify-center h-12 w-12 md:h-14 md:w-14 rounded-full bg-primary-900 text-primary-400">
              ...
              <div className="ml-4">
                <h3 className="text-lg md:text-xl font-semibold text-white">Create Your Profile</h3>
              </div>
            </div>
            <ul className="space-y-2 text-gray-400 text-sm md:text-base">
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 md:h-5 md:w-5 text-primary-400 mr-2 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
